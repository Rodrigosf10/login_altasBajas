    ...
    <div class="container">
        <div class="card border-0 shadow my-5">
            <div class="card-body p-5">
                <h1 class="fw-light text-center">Actualizar Registro</h1>
                <hr>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <select class="form-select border-dark" aria-label="Default select example" id="categoria" name="categoria" required>
                                    <option selected disabled>Anterior opcion: {{$items->categoria}}</option>
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control border-dark" aria-label="Amount (to the nearest dollar)" id="cantidad" name="cantidad" onkeypress="return validarNumero(event)" required value="{{$items->cantidad}}">
                                </div>
                            </div>
                            <div class="col-6">
                                <label for="exampleInputEmail1" class="form-label">Fecha:</label>
                                <input type="date" class="form-control border-dark" id="fecha" name="fecha" aria-describedby="emailHelp" required value="{{$items->fecha}}">
                            </div>
                        </div>
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Descripción:</label>
                        <input type="text" class="form-control border-dark" id="descripcion" name="descripcion" aria-describedby="emailHelp" required value="{{$items->descripcion}}">
                    </div>
                    <div class="row text-center">
                        <div class="col-sm-6"><button type="submit" class="btn btn-warning mt-3 border-dark"><i class="fa-solid fa-wrench"></i> Actualizar</button></div>
